...
public class SparseMatrix implements Matrix
{
    ...
    public SparseMatrix(String fileName) { //загружает матрицу из файла
        col = 0;
        row = 0;
    ...
    private SparseMatrix mul(SparseMatrix s) { // умножени разряженной на разряженную
    ...
    private DenseMatrix mul(DenseMatrix d) { //умножение заполененной на заполненную
     ...
     */
       ...
       final  Dispatcher dispatcher = new Dispatcher();
        ...
        final SparseMatrix sT = s.transpose();
    ...
    @Override
    public boolean equals(Object o) { //спавнивает с обоими вариантами
        boolean y = true;
        if (o instanceof DenseMatrix) {
