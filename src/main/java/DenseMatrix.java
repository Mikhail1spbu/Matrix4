...
public class DenseMatrix implements Matrix {
    ...
    public DenseMatrix(String fileName) { //загружает матрицу из файла
        try {
    ...
    public Matrix mul(Matrix o) { //однопоточное умнджение матриц
     ...
     */
     public DenseMatrix dmul(Matrix o) {
         ...
         final double[][] result = new double[data.length][d.data[0].length];
         final double[][] dT = d.transpose();
